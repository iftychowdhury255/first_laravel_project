                ...
                <div class="dropdown cart-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="product">
                                <div class="product-cart-details">
                                    ...
                                    <span class="cart-product-info">
                                        ...
                                        x ${{$totalPrice = $product->qty * $product->price}}
                                    </span>
                                </div><!-- End .product-cart-details -->
                                
                                <figure class="product-image-container">
                                    <a href="product.html" class="product-image">
                                        <img src="{{asset('/image/'.$product->products[0]->image)}}" alt="product">
                                    </a>
                                </figure>
                                <a href="{{url('/cart/delete/'.$product->id)}}" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                            </div><!-- End .product --> 
                            @php
                            $sum += $totalPrice
                         @endphp
                        ...
                        <div class="dropdown-cart-action">
                            <a href="{{url('/view/cart/products')}}" class="btn btn-primary">View Cart</a>
                            <a href="/customer/confirmed/order" class="btn btn-outline-primary-2"><span>Checkout</span><i class="icon-long-arrow-right"></i></a>
                        </div><!-- End .dropdown-cart-total -->
                    </div><!-- End .dropdown-menu -->
            ...
            <div class="header-center">
                <nav class="main-nav">
                    <ul class="menu sf-arrows">
                        ...
                        <li>
                            <a href="{{url('/shop/pages')}}" class="sf-with-ul">Shop</a>
