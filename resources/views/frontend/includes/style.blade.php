<link rel="apple-touch-icon" sizes="180x180" href="{{asset('/frontend/')}}/{{asset('/frontend/')}}/assets/images/icons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('/frontend/')}}/{{asset('/frontend/')}}/assets/images/icons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('/frontend/')}}/{{asset('/frontend/')}}/assets/images/icons/favicon-16x16.png">
    <link rel="manifest" href="{{asset('/frontend/')}}/{{asset('/frontend/')}}/assets/images/icons/site.html">
    <link rel="mask-icon" href="{{asset('/frontend/')}}/{{asset('/frontend/')}}/assets/images/icons/safari-pinned-tab.svg" color="#666666">
    <link rel="shortcut icon" href="{{asset('/frontend/')}}/{{asset('/frontend/')}}/assets/images/icons/favicon.ico">
